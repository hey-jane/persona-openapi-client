...
module PersonaAPIClient
  class InquiryAttributesAllOfFields
    ...
    def self.openapi_types
      {
        :'name_first' => :'InquiryAttributesAllOfFieldsNameFirst',
        :'name_middle' => :'InquiryAttributesAllOfFieldsNameFirst',
        :'name_last' => :'InquiryAttributesAllOfFieldsNameFirst',
        :'address_street_1' => :'InquiryAttributesAllOfFieldsNameFirst',
        :'address_street_2' => :'InquiryAttributesAllOfFieldsAddressStreet2',
        :'address_city' => :'InquiryAttributesAllOfFieldsAddressCity',
        :'address_subdivision' => :'InquiryAttributesAllOfFieldsAddressSubdivision',
        :'address_postal_code' => :'InquiryAttributesAllOfFieldsAddressPostalCode',
        :'address_country_code' => :'InquiryAttributesAllOfFieldsAddressCountryCode',
        :'birthdate' => :'InquiryAttributesAllOfFieldsBirthdate',
        :'email_address' => :'InquiryAttributesAllOfFieldsAddressStreet2',
        :'phone_number' => :'InquiryAttributesAllOfFieldsAddressStreet2',
        :'identification_number' => :'InquiryAttributesAllOfFieldsAddressStreet2'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PersonaAPIClient::InquiryAttributesAllOfFields` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PersonaAPIClient::InquiryAttributesAllOfFields`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
