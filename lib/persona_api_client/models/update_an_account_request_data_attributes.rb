...
module PersonaAPIClient
  class UpdateAnAccountRequestDataAttributes
    ...
    def self.openapi_types
      {
        ...
        :'selfie_photo' => :'UpdateAnAccountRequestDataAttributesAllOfSelfiePhoto',
        :'tags' => :'Array<String>',
        :'country_code' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PersonaAPIClient::UpdateAnAccountRequestDataAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PersonaAPIClient::UpdateAnAccountRequestDataAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [reference_id, account_status, selfie_photo, tags, country_code, social_security_number, fields, birthdate, name_first, name_middle, name_last, phone_number, email_address, address_street_1, address_street_2, address_city, address_subdivision, address_postal_code].hash
    end
