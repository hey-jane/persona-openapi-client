...
module PersonaAPIClient
  class ReportBusinessLookupRequestAttributesAllOfQuery
    # The name of the business to search.
    attr_accessor :business_name

    # The phone number of the business to search.
    attr_accessor :phone_number

    # The website of the business to search.
    attr_accessor :website

    # The Employer Identification Number (EIN) of the business to search.
    attr_accessor :ein
    ...
    # Officers or agents associated with the business.
    ...
    def self.openapi_types
      {
        ...
        :'associated_people' => :'Array<ReportBusinessLookupRequestAttributesAllOfQueryAssociatedPeopleInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PersonaAPIClient::ReportBusinessLookupRequestAttributesAllOfQuery` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PersonaAPIClient::ReportBusinessLookupRequestAttributesAllOfQuery`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [business_name, phone_number, website, ein, address_street_1, address_street_2, address_city, address_subdivision, address_postal_code, address_country_code, associated_people].hash
    end
