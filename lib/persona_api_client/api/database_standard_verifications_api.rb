...
module PersonaAPIClient
  class DatabaseStandardVerificationsApi
    ...
    def retrieve_a_database_standard_verification(verification_id, opts = {})
      data, _status_code, _headers = retrieve_a_database_standard_verification_with_http_info(verification_id, opts)
      data
    end
    ...
    # @option opts [String] :include A comma-separated list of relationship paths. This can be used to customize which related resources will be fully serialized in the &#x60;included&#x60; key in the response. See [Serialization](https://docs.withpersona.com/reference/serialization#inclusion-of-related-resources) for more details.
    # @option opts [String] :fields A comma-separated list of attributes to include in the response. This can be used to customize which attributes will be serialized in the response. See [Serialization](https://docs.withpersona.com/reference/serialization#sparse-fieldsets) for more details.
    # @return [Array<(RetrieveADatabaseStandardVerification200Response, Integer, Hash)>] RetrieveADatabaseStandardVerification200Response data, response status code and response headers
    def retrieve_a_database_standard_verification_with_http_info(verification_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DatabaseStandardVerificationsApi.retrieve_a_database_standard_verification ...'
      end
      # verify the required parameter 'verification_id' is set
      if @api_client.config.client_side_validation && verification_id.nil?
        fail ArgumentError, "Missing the required parameter 'verification_id' when calling DatabaseStandardVerificationsApi.retrieve_a_database_standard_verification"
      end
      ...
      # resource path
      local_var_path = '/verification/database-standards/{verification-id}'.sub('{' + 'verification-id' + '}', CGI.escape(verification_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RetrieveADatabaseStandardVerification200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"DatabaseStandardVerificationsApi.retrieve_a_database_standard_verification",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DatabaseStandardVerificationsApi#retrieve_a_database_standard_verification\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
