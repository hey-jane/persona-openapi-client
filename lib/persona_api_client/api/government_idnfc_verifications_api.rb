...
module PersonaAPIClient
  class GovernmentIDNFCVerificationsApi
    ...
    # @return [RetrieveAGovernmentIdNfcVerification200Response]
    def retrieve_a_government_id_nfc_verification(verification_id, opts = {})
      data, _status_code, _headers = retrieve_a_government_id_nfc_verification_with_http_info(verification_id, opts)
      data
    end
    ...
    # @option opts [String] :include A comma-separated list of relationship paths. This can be used to customize which related resources will be fully serialized in the &#x60;included&#x60; key in the response. See [Serialization](https://docs.withpersona.com/reference/serialization#inclusion-of-related-resources) for more details.
    # @option opts [String] :fields A comma-separated list of attributes to include in the response. This can be used to customize which attributes will be serialized in the response. See [Serialization](https://docs.withpersona.com/reference/serialization#sparse-fieldsets) for more details.
    # @return [Array<(RetrieveAGovernmentIdNfcVerification200Response, Integer, Hash)>] RetrieveAGovernmentIdNfcVerification200Response data, response status code and response headers
    def retrieve_a_government_id_nfc_verification_with_http_info(verification_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GovernmentIDNFCVerificationsApi.retrieve_a_government_id_nfc_verification ...'
      end
      # verify the required parameter 'verification_id' is set
      if @api_client.config.client_side_validation && verification_id.nil?
        fail ArgumentError, "Missing the required parameter 'verification_id' when calling GovernmentIDNFCVerificationsApi.retrieve_a_government_id_nfc_verification"
      end
      ...
      # resource path
      local_var_path = '/verification/government-id-nfcs/{verification-id}'.sub('{' + 'verification-id' + '}', CGI.escape(verification_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RetrieveAGovernmentIdNfcVerification200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"GovernmentIDNFCVerificationsApi.retrieve_a_government_id_nfc_verification",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GovernmentIDNFCVerificationsApi#retrieve_a_government_id_nfc_verification\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
