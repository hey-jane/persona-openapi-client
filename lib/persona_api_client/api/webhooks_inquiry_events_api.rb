...
module PersonaAPIClient
  class WebhooksInquiryEventsApi
    ...
    # @option opts [WebhookInquiryApprovedRequest] :webhook_inquiry_approved_request 
    # @return [nil]
    ...
    def webhook_inquiry_approved_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'webhook_inquiry_approved_request'])
    ...
    # @option opts [Integer] :persona_webhook_attempts_left The number of times that Persona will attempt to deliver this webhook. This value is decremented each time Persona attempts to deliver the webhook.
    # @option opts [Integer] :persona_webhook_first_attempted_at The time at which Persona first attempted to deliver this webhook. This value is a Unix timestamp in seconds.
    # @option opts [WebhookInquiryCompletedRequest] :webhook_inquiry_completed_request 
    # @return [nil]
    ...
    def webhook_inquiry_completed_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'webhook_inquiry_completed_request'])
    ...
    # @option opts [Integer] :persona_webhook_attempts_left The number of times that Persona will attempt to deliver this webhook. This value is decremented each time Persona attempts to deliver the webhook.
    # @option opts [Integer] :persona_webhook_first_attempted_at The time at which Persona first attempted to deliver this webhook. This value is a Unix timestamp in seconds.
    # @option opts [WebhookInquiryDeclinedRequest] :webhook_inquiry_declined_request 
    # @return [nil]
    ...
    def webhook_inquiry_declined_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'webhook_inquiry_declined_request'])
    ...
    # @option opts [Integer] :persona_webhook_attempts_left The number of times that Persona will attempt to deliver this webhook. This value is decremented each time Persona attempts to deliver the webhook.
    # @option opts [Integer] :persona_webhook_first_attempted_at The time at which Persona first attempted to deliver this webhook. This value is a Unix timestamp in seconds.
    # @option opts [WebhookInquiryFailedRequest] :webhook_inquiry_failed_request 
    # @return [nil]
    ...
    def webhook_inquiry_failed_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'webhook_inquiry_failed_request'])
    ...
    # @option opts [Integer] :persona_webhook_attempts_left The number of times that Persona will attempt to deliver this webhook. This value is decremented each time Persona attempts to deliver the webhook.
    # @option opts [Integer] :persona_webhook_first_attempted_at The time at which Persona first attempted to deliver this webhook. This value is a Unix timestamp in seconds.
    # @option opts [WebhookInquiryMarkedForReviewRequest] :webhook_inquiry_marked_for_review_request 
    # @return [nil]
    ...
    def webhook_inquiry_marked_for_review_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'webhook_inquiry_marked_for_review_request'])
    ...
    # @option opts [Integer] :persona_webhook_attempts_left The number of times that Persona will attempt to deliver this webhook. This value is decremented each time Persona attempts to deliver the webhook.
    # @option opts [Integer] :persona_webhook_first_attempted_at The time at which Persona first attempted to deliver this webhook. This value is a Unix timestamp in seconds.
    # @option opts [WebhookInquiryTransitionedRequest] :webhook_inquiry_transitioned_request 
    # @return [nil]
    ...
    def webhook_inquiry_transitioned_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'webhook_inquiry_transitioned_request'])
