# OpenapiClient::ListItemPhoneNumberRelationshipsCreatorData
...
OpenapiClient::ListItemPhoneNumberRelationshipsCreatorData.openapi_one_of
# =>
# [
...
OpenapiClient::ListItemPhoneNumberRelationshipsCreatorData.build(data)
# => #<ListItemBrowserFingerprintRelationshipsCreatorDataOneOf:0x00007fdd4aab02a0>

OpenapiClient::ListItemPhoneNumberRelationshipsCreatorData.build(data_that_doesnt_match)
# => nil
```
