# PersonaAPIClient::ListItemEmailAddressRelationshipsCreatorData
...
PersonaAPIClient::ListItemEmailAddressRelationshipsCreatorData.openapi_one_of
# =>
# [
...
PersonaAPIClient::ListItemEmailAddressRelationshipsCreatorData.build(data)
# => #<ListItemBrowserFingerprintRelationshipsCreatorDataOneOf:0x00007fdd4aab02a0>

PersonaAPIClient::ListItemEmailAddressRelationshipsCreatorData.build(data_that_doesnt_match)
# => nil
```
