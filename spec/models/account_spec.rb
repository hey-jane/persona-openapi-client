...
# Unit tests for PersonaAPIClient::Account
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PersonaAPIClient::Account do
  let(:instance) { PersonaAPIClient::Account.new }

  describe 'test an instance of Account' do
    it 'should create an instance of Account' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PersonaAPIClient::Account)
    end
  end
