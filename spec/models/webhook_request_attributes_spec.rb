...
# Unit tests for OpenapiClient::WebhookRequestAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebhookRequestAttributes do
  let(:instance) { OpenapiClient::WebhookRequestAttributes.new }
  ...
  describe 'test an instance of WebhookRequestAttributes' do
    it 'should create an instance of WebhookRequestAttributes' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::WebhookRequestAttributes)
    end
  end
