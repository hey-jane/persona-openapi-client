...
# Unit tests for PersonaAPIClient::GovernmentIDNFCVerificationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GovernmentIDNFCVerificationsApi' do
  before do
  ...
  describe 'test an instance of GovernmentIDNFCVerificationsApi' do
    it 'should create an instance of GovernmentIDNFCVerificationsApi' do
      expect(@api_instance).to be_instance_of(PersonaAPIClient::GovernmentIDNFCVerificationsApi)
    end
  end

  # unit tests for retrieve_a_government_id_nfc_verification
  ...
  describe 'retrieve_a_government_id_nfc_verification test' do
    it 'should work' do
