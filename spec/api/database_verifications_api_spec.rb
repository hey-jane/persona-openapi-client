...
# Unit tests for PersonaAPIClient::DatabaseVerificationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DatabaseVerificationsApi' do
  before do
  ...
  describe 'test an instance of DatabaseVerificationsApi' do
    it 'should create an instance of DatabaseVerificationsApi' do
      expect(@api_instance).to be_instance_of(PersonaAPIClient::DatabaseVerificationsApi)
    end
  end

  # unit tests for retrieve_a_database_verification
  ...
  describe 'retrieve_a_database_verification test' do
    it 'should work' do
