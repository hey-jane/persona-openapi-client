...
# Unit tests for PersonaAPIClient::ECBSVDatabaseVerificationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ECBSVDatabaseVerificationsApi' do
  before do
  ...
  describe 'test an instance of ECBSVDatabaseVerificationsApi' do
    it 'should create an instance of ECBSVDatabaseVerificationsApi' do
      expect(@api_instance).to be_instance_of(PersonaAPIClient::ECBSVDatabaseVerificationsApi)
    end
  end

  # unit tests for retrieve_an_ecbsv_database_verification
  ...
  describe 'retrieve_an_ecbsv_database_verification test' do
    it 'should work' do
